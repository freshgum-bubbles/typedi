...
export function FakeFeedDemo() {
  ...
  return (
    <div className={styles.fakeFeed} aria-label="An interactive example of a FeedService">
      <div className={clsx(styles.fakeFeedContent, 'shadow--tl')}>
        <div className={clsx(styles.roundedHeavy, styles.contentGrow)}>
          <div
            className={styles.fakeChatList}
            ref={fakeChatListRef}
            role="list"
            aria-label="A list of posts as part of the example"
          >
            {posts.map(post => (
