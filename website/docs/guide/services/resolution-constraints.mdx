...
Or, you want to take advantage of [container inheritance](../containers/inheritance.md)
...
import { Service, Optional } from '@typed-inject/inject';
...
import { Service, SkipSelf } from '@typed-inject/inject';
...
import { ContainerInstance, Service, HostContainer } from '@typed-inject/inject';
